...
func (StdioData_Channel) Descriptor() protoreflect.EnumDescriptor {
	return file_grpc_stdio_proto_enumTypes[0].Descriptor()
}

func (StdioData_Channel) Type() protoreflect.EnumType {
	return &file_grpc_stdio_proto_enumTypes[0]
}
...
func (StdioData_Channel) EnumDescriptor() ([]byte, []int) {
	return file_grpc_stdio_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *StdioData) Reset() {
	*x = StdioData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_stdio_proto_msgTypes[0]
...
func (*StdioData) Descriptor() ([]byte, []int) {
	return file_grpc_stdio_proto_rawDescGZIP(), []int{0}
}
...
var file_grpc_stdio_proto_rawDesc = []byte{
	0x0a, 0x10, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x73, 0x74, 0x64, 0x69, 0x6f, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x6f, 0x44, 0x61, 0x74, 0x61, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2e, 0x2f, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_grpc_stdio_proto_rawDescOnce sync.Once
	file_grpc_stdio_proto_rawDescData = file_grpc_stdio_proto_rawDesc
)

func file_grpc_stdio_proto_rawDescGZIP() []byte {
	file_grpc_stdio_proto_rawDescOnce.Do(func() {
		file_grpc_stdio_proto_rawDescData = protoimpl.X.CompressGZIP(file_grpc_stdio_proto_rawDescData)
	})
	return file_grpc_stdio_proto_rawDescData
}

var file_grpc_stdio_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_grpc_stdio_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_grpc_stdio_proto_goTypes = []interface{}{
	(StdioData_Channel)(0), // 0: plugin.StdioData.Channel
	(*StdioData)(nil),      // 1: plugin.StdioData
	(*emptypb.Empty)(nil),  // 2: google.protobuf.Empty
}
var file_grpc_stdio_proto_depIdxs = []int32{
...
func init() { file_grpc_stdio_proto_init() }
func file_grpc_stdio_proto_init() {
	if File_grpc_stdio_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_grpc_stdio_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_grpc_stdio_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_grpc_stdio_proto_goTypes,
		DependencyIndexes: file_grpc_stdio_proto_depIdxs,
		EnumInfos:         file_grpc_stdio_proto_enumTypes,
		MessageInfos:      file_grpc_stdio_proto_msgTypes,
	}.Build()
	File_grpc_stdio_proto = out.File
	file_grpc_stdio_proto_rawDesc = nil
	file_grpc_stdio_proto_goTypes = nil
	file_grpc_stdio_proto_depIdxs = nil
}
